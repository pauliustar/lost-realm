...
class World
{
	...
	public:
		...
		Config giftbox_config;
		Config socket_config;
		Config recycle_config;
		Config dungeons_config;
		...
		bool SpawnDungeonNPC(int id, int mapid, int mapx, int mapy, int speed);
		bool DungeonEnabled;
		bool SecretDungeon;
		bool EscapeDeath;
		bool SwitchingFloor;
		bool DisconnectTimerSeq;
