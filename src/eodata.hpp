...
template <class EIF> struct EIF_Data_Base
{
	...
	typename EIF::Element element;

	short element_attack;
	...
	conreq(0), chareq(0), element(EIF::True), element_attack(0), weight(0), size(EIF::Size1x1) { }
...
template <class ENF> struct ENF_Data_Base
{
	...
	//typename ENF::Element element_a_type;
	unsigned int element_attack;
	unsigned int element_weakness;
	//short element_power;
	short element_attack_dmg;
	short element_weakness_dmg;


	//typename ENF::Element element_w_type;
	...
	element_attack(0), element_attack_dmg(0), element_weakness(0), element_weakness_dmg(0)
	/* element_a_type(ENF::True), element_power(0), element_w_type(ENF::True), element_weakness(0) */ { }
