...
void eoserv_config_validate_config(Config& config)
{
	...
	eoserv_config_default(config, "GearboxFile"      , "./data/extras/gearbox.ini");
	eoserv_config_default(config, "GiftboxFile"      , "./data/extras/giftbox.ini");
	eoserv_config_default(config, "SocketsFile"      , "./data/extras/sockets.ini");
	eoserv_config_default(config, "RecycleFile"      , "./data/extras/recycle.ini");
	eoserv_config_default(config, "DungeonsFile"      , "./data/extras/dungeons.ini");
	...
	eoserv_config_default(config, "GuildPrice"         , 1000);
	eoserv_config_default(config, "RecruitCost"        , 100);
	eoserv_config_default(config, "GuildMaxMembers"    , 5000);
	eoserv_config_default(config, "GuildCreateMembers" , 1);
	...
	eoserv_config_default(config, "GuildMinDeposit"    , 100);
	...
	eoserv_config_default(config, "MaxHairStyle"       , 30);
	eoserv_config_default(config, "MaxHairColor"       , 9);
	eoserv_config_default(config, "MaxSkin"            , 6);
	eoserv_config_default(config, "CreateMinHairStyle" , 0);
	eoserv_config_default(config, "CreateMaxHairStyle" , 30);
	...
	eoserv_config_default(config, "AccountCreationDelay", 10);
	eoserv_config_default(config, "AccountValidation"  , 0);
	...
	eoserv_config_default(config, "PacketRateWalk"     , 0.26);
	...
	eoserv_config_default(config, "SoulItem"           , 14);
}
...
void eoserv_config_validate_admin(Config& config)
{
	...
	eoserv_config_default(config, "setfame"       , 3);
