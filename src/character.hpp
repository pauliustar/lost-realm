...
class Character : public Command_Source
{
	public:
		...
		int mindam, maxdam;
		int element_attack; // Elemental
		int element_weakness; // Elemental
		...
		std::list<Character_Item> weaponbank;
		std::list<Character_Item> shieldbank;
		std::list<Character_Item> cosmeticsbank;
